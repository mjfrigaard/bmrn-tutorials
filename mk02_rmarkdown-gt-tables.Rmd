...
It's good practice to include the source of the data in a table display. To do this in Excel, we would need to follow the steps outlined above, but in `gt` we can simply add a `tab_source_note()` function and include a text string for the `source_note =`. 
