...
```{r geom-line-us-cities-sol, fig.height=4, fig.width=6, out.height='100%', out.width='100%'}
TidyApple %>% 
  filter(geo_type == "city" &
              country == "United States") %>% 
  ggplot() +
...
```{r us-cities-line-alpha-sol, fig.height=4, fig.width=6, out.height='100%', out.width='100%'}
TidyApple %>% 
  filter(geo_type == "city" &
              country == "United States") %>% 
  ggplot() +
...
```{r lab_line_02-sol, fig.height=4, fig.width=6, out.height='100%', out.width='100%'}
lab_line_02 <- labs(x = "Date",
                 y = "Direction Requests",
                 title = "Direction Requests Over Time (US Cities Only)",
...
```{r label-plot-sol-01, fig.height=4, fig.width=6, out.height='100%', out.width='100%'}
TopUSCities %>% 
    ggplot() + 
    geom_line(aes(x = date, y = dir_request, 
                  group = trans_type, 
...
```{r label-plot-sol-02, fig.height=4, fig.width=6, out.height='100%', out.width='100%'}
TopUSCities %>% 
    ggplot() + 
    geom_line(aes(x = date, y = dir_request, 
                  group = trans_type, 
...
```{r TopCities-geom_line-sol, fig.height=4, fig.width=6, out.height='100%', out.width='100%'}
TopCities %>% 
  ggplot(aes(x = date, y = dir_request, 
             group = trans_type, 
             color = trans_type)) + 
...
```{r geom_hline-sol, fig.height=4, fig.width=6, out.height='100%', out.width='100%'}
...
```{r facet_wrap-sol, fig.height=4, fig.width=6, out.height='100%', out.width='100%'}
TopCities %>% 
  ggplot(aes(x = date, y = dir_request, 
             group = trans_type, 
             color = trans_type)) + 
...
```{r theme_minimal-sol, fig.height=5, fig.width=7, out.height='100%', out.width='100%'}
TopCities %>% 
  ggplot(aes(x = date, y = dir_request, 
             group = trans_type, 
             color = trans_type)) + 
...
```{r theme-sol, fig.height=5, fig.width=7, out.height='100%', out.width='100%'}
TopCities %>% 
  ggplot(aes(x = date, y = dir_request, 
             group = trans_type, 
             color = trans_type)) + 
...
```{r facet_wrap_paginate-sol, fig.height=5, fig.width=7, out.height='100%', out.width='100%'}
Top25TransitUSAllT1 %>% 
  # global settings
  ggplot(aes(x = date, y = dir_request, 
             group = trans_type, 
...
```{r scale_color_jcolors-sol, fig.height=5, fig.width=7, out.height='100%', out.width='100%'}
Top25TransitUSAllT1 %>% 
  # global settings
  ggplot(aes(x = date, y = dir_request, 
             group = trans_type, 
