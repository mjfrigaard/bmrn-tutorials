...
These data are from 2020-12-24.

```{r datapasta-current, echo=FALSE}
tibble::tribble(
...
We need to change the `color` and `weight` of the stock symbols and last price

### `style` fonts and color

We can control the font weight and color *inside* `colDef()` with the `style` argument.
...
## Add selecting {.tabset}

The last feature we'll add to this table is searching. This applies to the entire table. 
