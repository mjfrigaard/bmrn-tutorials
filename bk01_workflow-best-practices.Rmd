...
This document covers managing your code, data, and files with RStudio. We will start with a tour of the IDE, and some of the custom settings that you can do to increase your productivity. 

## Global Settings 

We will cover settings in the following sections: 

```{r setting-options, echo=FALSE, out.width='30%', out.height='30%', fig.align='left'}
...
Good folder and file organization saves time and headaches. See the tabs below for some basic guidelines. 
