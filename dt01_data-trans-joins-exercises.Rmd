---
title: "Reshaping, Transforming, and Joining Data in R"
...
```{r import-SmallLabData, echo=FALSE, message=FALSE, warning=FALSE}
AllLabs %>% 
...
```{r import-LabData, echo=FALSE, message=FALSE, warning=FALSE}
AllLabs %>% 
...
```{r import-LabProc, message=FALSE, warning=FALSE, echo=FALSE}
AllLabs %>% 
