...
This section covers some tips on managing your code, data, and files with RStudio. The sections below give a tour of the RStudio IDE, and some of the customizations that you can do to increase your productivity. 

I've included some comments in *italics*--these are just my personal observations, feel free to set up the IDE in the way that works best for you!
