...
```{r export-TopPharmCompRaw, echo=FALSE}
library(readr)
# little fail-safe here to export the current data as-is and read it back in just in case the data change in the future... 
write_rds(x = TopPharmCompRaw, path = "data/2020-11-24-TopPharmCompRaw.rds")
# read back in
TopPharmCompRaw <- read_rds(file = "data/2020-11-24-TopPharmCompRaw.rds")
```
