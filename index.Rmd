...
```{r create-x, include = FALSE, warning = FALSE}
...
```{r intro-files, results='asis', echo=FALSE, eval=TRUE}
...
```{r markdown-files, results='asis', echo=FALSE, eval=TRUE}
# this uses the `bk` as a prefix and identifier for the 'background' section
cat_bullet(x, "^mk")
```
...
# here we see the 'ex' for exercises 
cat_bullet(x, "^gg")
```
