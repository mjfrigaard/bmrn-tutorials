...
```{r biotech-and-drug-stocks}
BioTechDrugStocks <- read_csv("data/2020-12-11-BioTechDrugStocks.csv")
BioTechDrugStocks
```
...
biotech_symbols <- c("BMRN", "MRK", "AZN", "GSK", "BNTX", "MRNA")
...
```{r reactable-colDef}
reactable(bt_stocks_12_2020, columns = list(
  # add + or - for returns
  `Log Returns` = colDef(
    cell = function(value) {
